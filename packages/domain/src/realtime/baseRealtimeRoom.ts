...
export type RealtimeObservabilityChannel = 'faction' | 'region';

export interface RealtimeObservabilityEvent {
  channel: RealtimeObservabilityChannel;
  errorMessage?: string;
...
interface RealtimeObservabilityConfig {
  channel: RealtimeObservabilityChannel;
  onEvent: (input: RealtimeObservabilityEvent) => void;
}
...
export class BaseRealtimeRoomService<Snapshot, State> {
  ...
  protected readonly observability?: RealtimeObservabilityConfig;
  ...
  protected constructor(
    ...
    observability?: RealtimeObservabilityConfig,
  ) {
  ...
  protected recordRealtimeEvent(
    ...
    this.observability?.onEvent({
      channel: this.observability.channel,
      errorMessage,
      status,
    });
  }
