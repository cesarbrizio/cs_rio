...
export const catalogEntries: Array<Omit<MapStructureDefinition, 'placement'>> = [
  {
    category: 'favela',
  ...
  },
  {
    ...
    propertyTypeOptions: ['front_store', 'slot_machine', 'puteiro'],
    palette: {
      detail: '#27313b',
      detailSoft: '#9eb4c4',
      glow: '#82b4d0',
  ...
  },
  {
    ...
    propertyTypeOptions: ['beach_house'],
    palette: {
      detail: '#33414d',
      detailSoft: '#d5dde5',
      glow: '#8ec8ff',
