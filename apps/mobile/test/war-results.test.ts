    ...
    favelas: [
      {
        ...
        war: {
          ...
          rounds: [
            {
              attackerHpLoss: 14,
              attackerDisposicaoLoss: 9,
              attackerPower: 400,
              attackerCansacoLoss: 11,
              defenderHpLoss: 18,
              defenderDisposicaoLoss: 10,
              defenderPower: 350,
              defenderCansacoLoss: 12,
              message: 'Round 1',
              outcome: 'attacker',
            ...
            {
              attackerHpLoss: 20,
              attackerDisposicaoLoss: 11,
              attackerPower: 420,
              attackerCansacoLoss: 16,
              defenderHpLoss: 24,
              defenderDisposicaoLoss: 12,
              defenderPower: 330,
              defenderCansacoLoss: 18,
              message: 'Round 2',
              outcome: 'attacker',
