CREATE TABLE "rave_drug_lineups" (
	"property_id" uuid NOT NULL,
	"drug_id" uuid NOT NULL,
	"quantity" integer DEFAULT 0 NOT NULL,
	"price_multiplier" numeric(6, 2) DEFAULT '1.55' NOT NULL,
	CONSTRAINT "rave_drug_lineups_property_id_drug_id_pk" PRIMARY KEY("property_id","drug_id")
);
--> statement-breakpoint
CREATE TABLE "rave_operations" (
