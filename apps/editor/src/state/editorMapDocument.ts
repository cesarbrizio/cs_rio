...
type EditorMapLayer = EditorObjectLayerState | EditorTileLayerState;
...
const STRUCTURES_LAYER_NAME = 'structures';
...
function inferTiledPropertyType(value: TilePropertyValue): 'bool' | 'float' | 'int' | 'string' {
